...
module.exports = jQuery;}, "spine/index": function(exports, require, module) {module.exports = require('./lib/spine');}, "spine/lib/spine": function(exports, require, module) {// Generated by CoffeeScript 1.8.0
...
buf.push("<h2><div>Test " + (jade.escape((jade_interp = version) == null ? '' : jade_interp)) + "</div><span>Welcome</span><span class=\"firstName\">" + (jade.escape((jade_interp = firstname) == null ? '' : jade_interp)) + " </span><span class=\"lastName\">" + (jade.escape((jade_interp = lastname) == null ? '' : jade_interp)) + "</span></h2><div id=\"form\"><form><select class=\"form-control\"><option>none</option>");
// iterate tmodels
;(function(){
  var $$obj = tmodels;
...
if ( id === val.id)
{
buf.push("<option selected=\"selected\">" + (jade.escape(null == (jade_interp = val.id) ? "" : jade_interp)) + "</option>");
}
else
{
buf.push("<option>" + (jade.escape(null == (jade_interp = val.id) ? "" : jade_interp)) + "</option>");
}
    }
